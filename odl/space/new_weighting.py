...
class Weighting(object):
    def __init__(self, **kwargs):
        ...
        if 'inner' in kwargs:
            ...
            self.__norm  = not_implemented('norm', 'dist')
    ...
    def inner(self, x1, x2):
        ...
        """
        return self.__inner((self.__weight * x1.data).ravel(), x2.data.ravel()).astype(float)
    ...
    def norm(self, x):
        ...
        """
        return self.__array_norm(self.__weight * x.data, ord=self.exponent).astype(float)
